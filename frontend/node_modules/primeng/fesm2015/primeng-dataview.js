...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r337.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r344); const ctx_r343 = ɵngcc0.ɵɵnextContext(); return ctx_r343.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r338 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r338.rows)("first", ctx_r338.first)("totalRecords", ctx_r338.totalRecords)("pageLinkSize", ctx_r338.pageLinks)("alwaysShow", ctx_r338.alwaysShowPaginator)("rowsPerPageOptions", ctx_r338.rowsPerPageOptions)("dropdownAppendTo", ctx_r338.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r338.paginatorDropdownScrollHeight)("templateLeft", ctx_r338.paginatorLeftTemplate)("templateRight", ctx_r338.paginatorRightTemplate)("currentPageReportTemplate", ctx_r338.currentPageReportTemplate)("showCurrentPageReport", ctx_r338.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r339.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r345, rowIndex_r346));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r340.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r349); const ctx_r348 = ɵngcc0.ɵɵnextContext(); return ctx_r348.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r341 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r341.rows)("first", ctx_r341.first)("totalRecords", ctx_r341.totalRecords)("pageLinkSize", ctx_r341.pageLinks)("alwaysShow", ctx_r341.alwaysShowPaginator)("rowsPerPageOptions", ctx_r341.rowsPerPageOptions)("dropdownAppendTo", ctx_r341.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r341.paginatorDropdownScrollHeight)("templateLeft", ctx_r341.paginatorLeftTemplate)("templateRight", ctx_r341.paginatorRightTemplate)("currentPageReportTemplate", ctx_r341.currentPageReportTemplate)("showCurrentPageReport", ctx_r341.showCurrentPageReport);
} }
