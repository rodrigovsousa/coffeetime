...
function Panel_div_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("id", ctx_r432.id + "_header");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r432.header);
} }
function Panel_div_1_a_3_Template(rf, ctx) { if (rf & 1) {
    const _r435 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 9);
    ɵngcc0.ɵɵlistener("click", function Panel_div_1_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r435); const ctx_r434 = ɵngcc0.ɵɵnextContext(2); return ctx_r434.onIconClick($event); })("keydown.enter", function Panel_div_1_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r435); const ctx_r436 = ɵngcc0.ɵɵnextContext(2); return ctx_r436.onIconClick($event); });
    ɵngcc0.ɵɵelement(1, "span");
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r433 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵattribute("id", ctx_r433.id + "-label")("aria-controls", ctx_r433.id + "-content")("aria-expanded", !ctx_r433.collapsed);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap(ctx_r433.collapsed ? ctx_r433.expandIcon : ctx_r433.collapseIcon);
} }
...
function Panel_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Panel_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r438); const ctx_r437 = ɵngcc0.ɵɵnextContext(); return ctx_r437.onHeaderClick($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(4, _c0, ctx_r430.toggleable && ctx_r430.toggler === "header"));
    ɵngcc0.ɵɵattribute("id", ctx_r430.id + "-titlebar");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r430.header);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r430.toggleable);
} }
