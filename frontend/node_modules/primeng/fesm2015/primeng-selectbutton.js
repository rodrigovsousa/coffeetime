...
function SelectButton_div_1_ng_container_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r649 = ɵngcc0.ɵɵnextContext(2).$implicit;
    ɵngcc0.ɵɵclassMap(option_r649.icon);
...
function SelectButton_div_1_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r649 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", option_r649.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(option_r649.label || "ui-btn");
} }
...
function SelectButton_div_1_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const option_r649 = ctx_r659.$implicit;
    const i_r650 = ctx_r659.index;
    const ctx_r654 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r654.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c1, option_r649, i_r650));
} }
...
function SelectButton_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SelectButton_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r661); const option_r649 = ctx.$implicit; const i_r650 = ctx.index; const ctx_r660 = ɵngcc0.ɵɵnextContext(); return ctx_r660.onItemClick($event, option_r649, i_r650); })("keydown.enter", function SelectButton_div_1_Template_div_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r661); const option_r649 = ctx.$implicit; const i_r650 = ctx.index; const ctx_r662 = ɵngcc0.ɵɵnextContext(); return ctx_r662.onItemClick($event, option_r649, i_r650); })("focus", function SelectButton_div_1_Template_div_focus_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r661); const ctx_r663 = ɵngcc0.ɵɵnextContext(); return ctx_r663.onFocus($event); })("blur", function SelectButton_div_1_Template_div_blur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r661); const ctx_r664 = ɵngcc0.ɵɵnextContext(); return ctx_r664.onBlur($event); });
    ...
    const option_r649 = ctx.$implicit;
    const _r651 = ɵngcc0.ɵɵreference(1);
    const _r653 = ɵngcc0.ɵɵreference(4);
    const ctx_r648 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵclassMapInterpolate1("ui-button ui-widget ui-state-default ui-button-text-only ", option_r649.styleClass, "");
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction5(11, _c2, ctx_r648.isSelected(option_r649), ctx_r648.disabled || option_r649.disabled, _r651 == ctx_r648.focusedItem, option_r649.icon != null, option_r649.icon && !option_r649.label));
    ɵngcc0.ɵɵattribute("aria-pressed", ctx_r648.isSelected(option_r649))("title", option_r649.title)("aria-label", option_r649.label)("tabindex", ctx_r648.tabindex)("aria-labelledby", ctx_r648.ariaLabelledBy);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r648.itemTemplate)("ngIfElse", _r653);
} }
