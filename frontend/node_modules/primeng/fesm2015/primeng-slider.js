...
function Slider_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c3, ctx_r700.handleValues[0] + "%", ctx_r700.handleValues[1] - ctx_r700.handleValues[0] + "%"));
} }
...
function Slider_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(1, _c4, ctx_r701.handleValues[0] + "%", ctx_r701.handleValues[1] - ctx_r701.handleValues[0] + "%"));
} }
...
function Slider_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c5, ctx_r702.handleValue + "%"));
} }
...
function Slider_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(1, _c6, ctx_r703.handleValue + "%"));
} }
...
function Slider_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_5_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r708 = ɵngcc0.ɵɵnextContext(); return ctx_r708.onHandleKeydown($event); })("mousedown", function Slider_span_5_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r710 = ɵngcc0.ɵɵnextContext(); return ctx_r710.onMouseDown($event); })("touchstart", function Slider_span_5_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r711 = ɵngcc0.ɵɵnextContext(); return ctx_r711.onTouchStart($event); })("touchmove", function Slider_span_5_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r712 = ɵngcc0.ɵɵnextContext(); return ctx_r712.onTouchMove($event); })("touchend", function Slider_span_5_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r709); const ctx_r713 = ɵngcc0.ɵɵnextContext(); return ctx_r713.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r704 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r704.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(8, _c7, ctx_r704.orientation == "horizontal" ? ctx_r704.handleValue + "%" : null, ctx_r704.orientation == "vertical" ? ctx_r704.handleValue + "%" : null));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r704.tabindex)("aria-valuemin", ctx_r704.min)("aria-valuenow", ctx_r704.value)("aria-valuemax", ctx_r704.max)("aria-labelledby", ctx_r704.ariaLabelledBy);
} }
...
function Slider_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_6_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r716); const ctx_r715 = ɵngcc0.ɵɵnextContext(); return ctx_r715.onHandleKeydown($event, 0); })("mousedown", function Slider_span_6_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r716); const ctx_r717 = ɵngcc0.ɵɵnextContext(); return ctx_r717.onMouseDown($event, 0); })("touchstart", function Slider_span_6_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r716); const ctx_r718 = ɵngcc0.ɵɵnextContext(); return ctx_r718.onTouchStart($event, 0); })("touchmove", function Slider_span_6_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r716); const ctx_r719 = ɵngcc0.ɵɵnextContext(); return ctx_r719.onTouchMove($event, 0); })("touchend", function Slider_span_6_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r716); const ctx_r720 = ɵngcc0.ɵɵnextContext(); return ctx_r720.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r705 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r705.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r705.rangeStartLeft, ctx_r705.rangeStartBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r705.handleIndex == 0));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r705.tabindex)("aria-valuemin", ctx_r705.min)("aria-valuenow", ctx_r705.value ? ctx_r705.value[0] : null)("aria-valuemax", ctx_r705.max)("aria-labelledby", ctx_r705.ariaLabelledBy);
} }
function Slider_span_7_Template(rf, ctx) { if (rf & 1) {
    const _r723 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 9, 11);
    ɵngcc0.ɵɵlistener("keydown", function Slider_span_7_Template_span_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r723); const ctx_r722 = ɵngcc0.ɵɵnextContext(); return ctx_r722.onHandleKeydown($event, 1); })("mousedown", function Slider_span_7_Template_span_mousedown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r723); const ctx_r724 = ɵngcc0.ɵɵnextContext(); return ctx_r724.onMouseDown($event, 1); })("touchstart", function Slider_span_7_Template_span_touchstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r723); const ctx_r725 = ɵngcc0.ɵɵnextContext(); return ctx_r725.onTouchStart($event, 1); })("touchmove", function Slider_span_7_Template_span_touchmove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r723); const ctx_r726 = ɵngcc0.ɵɵnextContext(); return ctx_r726.onTouchMove($event, 1); })("touchend", function Slider_span_7_Template_span_touchend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r723); const ctx_r727 = ɵngcc0.ɵɵnextContext(); return ctx_r727.onTouchEnd($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r706 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵstyleProp("transition", ctx_r706.dragging ? "none" : null);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction2(9, _c7, ctx_r706.rangeEndLeft, ctx_r706.rangeEndBottom))("ngClass", ɵngcc0.ɵɵpureFunction1(12, _c8, ctx_r706.handleIndex == 1));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r706.tabindex)("aria-valuemin", ctx_r706.min)("aria-valuenow", ctx_r706.value ? ctx_r706.value[1] : null)("aria-valuemax", ctx_r706.max)("aria-labelledby", ctx_r706.ariaLabelledBy);
} }
