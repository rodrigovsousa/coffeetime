...
function VirtualScroller_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r925 = ctx.$implicit;
    const i_r926 = ctx.index;
    const c_r927 = ctx.count;
    const f_r928 = ctx.first;
    const l_r929 = ctx.last;
    const e_r930 = ctx.even;
    const o_r931 = ctx.odd;
    const ctx_r923 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngStyle", ɵngcc0.ɵɵpureFunction1(3, _c0, ctx_r923.itemSize + "px"));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", item_r925 ? ctx_r923.itemTemplate : ctx_r923.loadingItemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction7(5, _c1, item_r925, i_r926, c_r927, f_r928, l_r929, e_r930, o_r931));
} }
